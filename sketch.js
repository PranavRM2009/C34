...
var empty_star, one_star, two_star,star_img

var star, star2, stardisplay
...
function setup() 
{
  ...
  button3.position(250,340);
  button3.size(100,125);
  button3.mouseClicked(airBlow);
   ...
   star = createSprite(310,40,10,10)
   star.addImage(star_img)
   star.scale = 0.02

   star2 = createSprite(120,400,10,10)
   star2.addImage(star_img)
   star2.scale = 0.02

   stardisplay = createSprite(90,40,10,10)
